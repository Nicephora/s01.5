...
#   puts "il y a #{journalist.length} journalistes dans la liste"
#
# def count(string)
#   string.scan(/\d+/) do
#     return 1
...
#      number_of_number += count(array[i])
#   end
#   puts "il y a #{number_of_number} journalistes avec au moin un chiffre dans leur pseudo"
# end
# total_count(journalist)
#
# puts "il y a " + journalist.select {
#   |nom| #variable de boucle
#   nom.downcase.include?("aude")#condition
# }.length.to_s + " journalistes avec les lettres aude"
#
#
# puts "il y a " + journalist.select {
#   |nom| #variable de boucle
#   nom.upcase[1] == nom[1]#condition
# }.length.to_s + " qui commence par une majuscule"
#
# puts "il y a " + journalist.select {
#   |nom| #variable de boucle
#   nom.downcase != nom#condition
# }.length.to_s + " qui contiennent une majuscule"
#
# def count_underscore(array)
#   underscore=0
#   for i in (0...array.length)
#     underscore += array[i].count("_")
#   end
#   puts underscore
# end
# count_underscore (journalist)

#puts journalist.sort_by(&:downcase)

# puts journalist.sort_by{
#   |name|
# name.size
#  }[0,50]
