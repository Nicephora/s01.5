...
# puts "Combien y a-t-il de journalistes dans ce array ? \n Il contient #{journalist.length} éléments"


# compteur = 0

# journalist.each do |name|
	
#  	if name.count("0-9") > 0 == true 
...
puts journalist.sort(&:casecmp)

end


def exo8
puts journalist.sort_by { |obj| obj.length }.take(49)
